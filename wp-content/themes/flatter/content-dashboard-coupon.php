...
<tr class="<?php echo $status; ?>">
	<td class="listing-count"><?php echo $i; ?>.</td>
	...
	<?php if ( current_theme_supports( 'app-stats' ) ) { ?>
		<td class="listing-views"><?php echo appthemes_get_stats_by( $post->ID, 'total' ); ?></td>
	<?php } ?>
	...
	<td class="listing-options"><?php clpr_dashboard_listing_actions( $post->ID ); ?></td>
