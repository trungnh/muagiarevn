								...
								?>
										...
										<?php else: ?>
											...
											<div class="user-pass1-wrap manage-password">
												<label for="pass1"><?php _e( 'New Password', APP_TD ); ?></label>
												<li>
													<button type="button" class="btn wp-generate-pw hide-if-no-js"><?php _e( 'Generate Password', APP_TD ); ?></button>

													<span class="wp-pwd hide-if-js">
														<?php $initial_password = wp_generate_password( 24 ); ?>
														<input type="password" id="pass1" name="pass1" class="text regular-text" autocomplete="off" data-reveal="1" data-pw="<?php echo esc_attr( $initial_password ); ?>" aria-describedby="pass-strength-result" />
												...
												<li class="wp-pwd hide-if-js">
													<label>&nbsp;</label>
													<div>
														<button type="button" class="btn wp-hide-pw hide-if-no-js" data-start-masked="<?php echo (int) isset( $_POST['pass1'] ); ?>" data-toggle="0" aria-label="<?php esc_attr_e( 'Hide password' ); ?>">
															<span class="dashicons dashicons-hidden"></span>
															<span class="text"><?php _e( 'Hide', APP_TD ); ?></span>
														</button>
														<button type="button" class="btn wp-cancel-pw hide-if-no-js" data-toggle="0" aria-label="<?php esc_attr_e( 'Cancel password change', APP_TD ); ?>">
