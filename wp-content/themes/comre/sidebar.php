<div class="blog-box clearfix">
    ...
    <div class="meta">
        ...
        <span><a href="<?php echo get_author_posts_url( get_the_author_meta('ID') ); ?>" title="<?php the_author_meta( 'display_name' ); ?>"><?php esc_html_e('by : ' , 'comre'); ?><?php the_author(); ?></a></span>

        <span><?php esc_html_e('in : ' , 'comre'); ?><?php the_category(', '); ?></span>
    ...
    <div class="desc">
        ...
        <a href="<?php the_permalink(); ?>" class="readmore" title="<?php the_title_attribute(); ?>"><?php esc_html_e('Read More' , 'comre'); ?><i class="icon-angle-double-right"></i></a>
