...
function sh_theme_init()
{
	...
	if( is_admin() ) {
		...
		if( sh_set( $_GET, 'page' ) == 'comre'.'_option' ) 
		{
	...
	$theme_options = new VP_Option(array(
		...
		'option_key'            => 'comre'.'_theme_options',                      // options key in db, required
		'page_slug'             => 'comre'.'_option',                      // options page slug, required
		...
		'page_title'            => __( 'Theme Options', 'comre' ), // page title
		'menu_label'            => __( 'Theme Options', 'comre' ), // menu label
	));
	
		_WSH()->user_extra( array('facebook'=>__('Facebook', 'comre'), 'twitter'=>__('Twitter', 'comre'), 'dribbble'=>__('Dribble', 'comre'), 'github'=>__('Github', 'comre'),
	'flickr'=>__('Flickr', 'comre'), 'google-plus'=>__('Google+', 'comre'), 'youtube'=>__('Youtube', 'comre')) );
...
// shortocode generators
 ...
 $tmpl_sg = array(
  'name' => 'sg_1',
  'template' => $tmpl_sg1,
  'modal_title' => __( 'Pretty Shortcodes', 'comre'),
  'button_title' => __('Pretty', 'comre'),
  'types' => array(  'page' ),
