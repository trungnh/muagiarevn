...
class CLPR_Theme_Settings_General extends APP_Tabs_Page {
	...
	protected function init_tabs() {
		...
		$this->tabs->add( 'coupons', __( 'Coupons', APP_TD ) );
		...
		$this->tab_sections['general']['configuration'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'type' => 'text',
					'name' => 'favicon_url',
					'tip' => __( 'This will replace the default favicon (i.e. http://www.yoursite.com/favicon.ico).', APP_TD ),
				),
				array(
		...
		$this->tab_sections['coupons']['configuration'] = array(
			...
			'fields' => array(
				array(
					...
					'name' => 'coupon_edit',
					'type' => 'checkbox',
					'desc' => __( 'Allow users to edit and republish their coupons', APP_TD ),
					'tip' => __( 'They can manage and edit coupons from their dashboard.', APP_TD ),
				),
				array(
		...
		$this->tab_sections['coupons']['pricing'] = array(
			...
			'fields' => array(
				array(
					...
					'tip' => __( 'This activates the payments system. Left unchecked, coupons will be free to post.', APP_TD ),
				),
				array(
					'title' => __( 'Coupon Price', APP_TD ),
					'desc' => __( 'Amount you will charge to post a coupon', APP_TD ),
					'type' => 'text',
					'name' => 'coupon_price',
					'tip' => __( 'Only enter numeric values or decimal points. Do not include a currency symbol or commas.', APP_TD ),
					'extra' => array(
						'class' => 'small-text'
					),
				),
		...
		$this->tab_sections['coupons']['coupon_page'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'type' => 'checkbox',
					'desc' => __( 'Hide links to single coupon pages', APP_TD ),
					'tip' => __( 'These pages will not be indexed by search engines.', APP_TD ),
				),
				array(
				...
				array(
					...
					'tip' => __( 'The default is to use a popup window.', APP_TD ) . ' ' .
					         sprintf( __( 'NOTE: This option will be ignored in case that Flash object is disabled in a user\'s browser or if option %s is enabled.', APP_TD ), __( 'Coupon Code', APP_TD ) ),
				),
				array(
					'title' => __( 'Allow HTML', APP_TD ),
					'name' => 'allow_html',
					'type' => 'checkbox',
					'desc' => __( 'Permit users to use HTML within their coupon listings', APP_TD ),
		...
		$this->tab_sections['coupons']['moderate'] = array(
			'title' => __( 'Moderate', APP_TD ),
			'fields' => array(

				array(
					'title' => __( 'Coupons', APP_TD ),
					'name' => 'coupons_require_moderation',
					'type' => 'checkbox',
					'desc' => __( 'Manually approve and publish each new coupon', APP_TD ),
					'tip' => __( 'Left unchecked, coupons go live immediately without being moderated (unless it has not been paid for).', APP_TD ),
				),
				array(
	...
	protected function init_tabs() {
		...
		$this->tab_sections['general']['notifications'] = array(
			...
			'fields' => array(
				...
				array(
					'title' => __( 'New Coupon', APP_TD ),
					'name' => 'new_ad_email',
					'type' => 'checkbox',
					'desc' => __( 'Send an email when a new coupon has been submitted', APP_TD ),
					'tip' => '',
				),
				array(
		...
		$this->tab_sections['new_coupon']['settings'] = array(
			...
			'fields' => array(
				array(
					...
					'type' => 'checkbox',
					'desc' => __( 'Send a custom coupon notification email to your users', APP_TD ),
					'tip' => __( 'Triggered when a new coupon is submitted. If you do not require user registration to submit coupons, no email will be sent out.', APP_TD ),
				),
				array(
					'title' => __( 'Name', APP_TD ),
					'type' => 'text',
