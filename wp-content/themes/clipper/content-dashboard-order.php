...
<tr class="<?php echo $order->get_status(); ?>">
	<td class="order-id">#<?php echo $order->get_id(); ?></td>
	...
	<td class="order-price"><?php appthemes_display_price( $order->get_total() ); ?></td>
	...
	<td class="order-options"><?php clpr_dashboard_order_actions( $post->ID ); ?></td>
